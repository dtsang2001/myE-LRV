...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h1 class="m-0 text-dark">Thêm Danh Mục Tin Tức</h1>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card-body">
                        <form action="" method="POST">                                            
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Nhập Tên Danh Mục" value="" onkeyup="autoSlug();">
                            </div>
                        
                            <div class="form-group">
                                <label for="InputSlugCategory">Đường Link</label>
                                <input type="text" class="form-control" name="slug" id="slug" placeholder="Đường Link" value="">
                            </div>                            
