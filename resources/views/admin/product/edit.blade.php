        ...
        <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{$id->name}}" onkeyup="autoSlug();">
                        </div>

                        <div class="form-group">
                            <label for="InputSlugProduct">Đường Link</label>
                            <input type="text" class="form-control" id="slug" name="slug" value="{{$id->slug}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select" name="category_id">
                                ...
                                @foreach($cats as $cat)
                                <?php $selected = ($cat->id == $id->category_id)? 'selected' : '' ?>
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="unit_price" name="unit_price" class="form-control" value="{{$id->unit_price}}">
                        </div>

                        <div class="form-group">
                            <label for="InputPriceProduct">Giá Khuyễn Mãi</label>
                            <input type="number" id="sale_price" name="sale_price" value="{{$id->sale_price}}" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="InputStockProduct">Số lượng trong kho</label>
                            <input type="number" id="unit_in_stock" name="unit_in_stock" class="form-control" value="{{$id->unit_in_stock}}">
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group" >
                            ...
                            <div id="myViewParent" class="clearfix">
                                <div id="myViewChild">
                                    @foreach ($id->product_image as $img)
            ...
            <div class="col-12">
                ...
                <div class="input-group input-group-sm" style="width: 150px; float: right; margin: 20px 0">
                    <button class="btn btn-block btn-success">Cập nhật</button>
                </div>
            </div>
        </div>
    </form>
