...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h1 class="m-0 text-dark">Sửa Tin</h1>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="title" onkeyup="autoSlug();" value="{{ $poster->title }}">
                        </div>

                        <div class="form-group">
                            <label for="InputSlugNews">Đường Link</label>
                            <input type="text" class="form-control" id="slug" name="slug" value="{{ $poster->slug }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select" name="category_news_id">
                                ...
                                <?php $selected = ($cn->id == $poster->category_news_id)? 'selected' : '' ?>
                                <option {{$selected}} value="{{$cn->id}}">{{$cn->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group" style="width: 400px">
                            ...
                            <div id="myViewParent" class="clearfix">
                                <div id="myViewChild">
                                    <div id="myViewImage0" class="myImage">
                                        <img src="uploads/{{$poster->image}}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="10" name="content" id="description">
                                {!! $poster->content !!}
                            </textarea>
                        </div>
